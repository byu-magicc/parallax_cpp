...
shared_ptr<common::ESolver> common::ESolver::from_yaml(string yaml_filename, string result_directory)
{
	...
	{
		gnsac_ptr_eigen::GNSAC_Solver* ptr1 = new gnsac_ptr_eigen::GNSAC_Solver(yaml_filename, node, result_directory);
		ESolver* ptr2 = (ESolver*)ptr1;
		return shared_ptr<ESolver>(ptr2);
	}
	else if (library_name == "five_point_opencv")
	{
		five_point_opencv::FivePointSolver* ptr1 = new five_point_opencv::FivePointSolver(yaml_filename, node, result_directory);
		ESolver* ptr2 = (ESolver*)ptr1;
		return shared_ptr<ESolver>(ptr2);
	}
